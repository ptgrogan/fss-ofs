...
define(function(require) {
    ...
    fss.SimpleFederateOperations = require('simpleFederateOperations');
    fss.DynamicFederateOperations = require('dynamicFederateOperations');
    fss.DynamicFederationOperations = require('dynamicFederationOperations');
    fss.FixedCostFederationOperations = require('fixedCostFederationOperations');
    fss.DynamicFixedCostFederationOperations = require('dynamicFixedCostFederationOperations');
