...
define('spaceGroundLink', function(require) {
     ...
     * @param {object} dataSize - The data isze.
     * @param {object} destLoc - The destination location.
     * @param {object} context - The context.
     * @returns {Boolean} True, if this transceiver can receive data.
     */
    SpaceGroundLink.prototype.canReceive = function(origLoc, transmitter, dataSize, destLoc, context) {
     ...
     */
    SpaceGroundLink.prototype.canTransmit = function(origLoc, dataSize, destLoc, receiver, context) {
