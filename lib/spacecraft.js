    ...
    Spacecraft.prototype.canSense = function(demand, context) {
        ...
        if(!this.isCommissioned()) {
            ...
            return _.reduce(_.filter(this.subsystems, function(subsystem) {
                ...
                return memo || sensor.canSense(this, demand, context);
            }, false, this);
        }
        return false;
    };
    ...
    Spacecraft.prototype.sense = function(contract, context) {
        if(this.canSense(contract.demand, context)) {
            if(_.reduce(_.filter(this.subsystems, function(subsystem) {
                ...
                return memo || sensor.sense(this, contract, context);
            }, false, this)) {
                logger.verbose(this.getTag() + " sensed data for " 
                        + contract.demand.type);
                return true;
            }
        }
        return false;
