                    ...
                    _.each(SGLprotocols, function(protocol, k) {
                        ...
                        _.each(demands, function(demand, l) {
                            ...
                            C.push({
                                ...
                                name: spacecraft.id + '-' + station.id + ' ' + protocol + ' visibility for ' + demand.id + ' at ' + time
                            });
                        }, this);
                        _.each(contracts, function(contract, l) {
                            ...
                            C.push({
                                ...
                                name: spacecraft.id + '-' + station.id + ' ' + protocol + ' visibility for ' + contract.demand.id + ' at ' + time
                            });
                        }, this);
                    }, this);
                }, this);
                    ...
                    _.each(ISLprotocols, function(protocol, k) {
                        ...
                        _.each(demands, function(demand, l) {
                            ...
                            C.push({
                                ...
                                name: spacecraft.id + '-' + spacecraft2.id + ' ' + protocol + ' visibility for ' + demand.id + ' at ' + time
                            });
                        }, this);
                        _.each(contracts, function(contract, l) {
                            ...
                            C.push({
                                ...
                                constant: (spacecraft.couldTransmit(protocol, 
                                    ...
                                    && spacecraft2.couldReceive(protocol, 
                                        origLoc, destLoc, spacecraft, 
                                        contract.demand.size, context)
                                    && spacecraft !== spacecraft2)?1:0,
                                name: spacecraft.id + '-' + spacecraft2.id + ' ' + protocol + ' visibility for ' + contract.demand.id + ' at ' + time
                            });
                        }, this);
                    }, this);
                }, this);
			...
			var transportContract = function(operations, spacecraft, contract, context) {
				...
				if((data = federate1.getData(contract)) !== undefined) {
					if(lp.get(R_c[0][R_i][j]) > 0) {
						...
						if(isl_i >= 0) {
							_.each(spacecraftsISL, function(spacecraft2, k) {
								var E_k = _.indexOf(spacecrafts, spacecraft2);
								_.each(ISLprotocols, function(protocol, l) {
