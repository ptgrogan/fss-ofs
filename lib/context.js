...
define('context', function(require) {
    ...
    Context.prototype.getShuffledFederations = function() {
        return Random.shuffle(this.orderStream, this.federations);
    }
    ...
    Context.prototype.getShuffledFederates = function(federation) {
        return Random.shuffle(this.orderStream, federation.federates);
    }
    ...
    Context.prototype.tock = function() {
        ...
        logger.verbose('Start Turn ' + this.time);
        ...
        logger.verbose('End Turn ' + this.time);
    };
