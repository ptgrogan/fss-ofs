...
define('context', function(require) {
    ...
    /**
     * Gets a list of federates in shuffled order.
     * @returns {Array} The list of federates in shuffled order.
     */
    Context.prototype.getShuffledFederates = function() {
        return Random.shuffle(this.orderStream, _.flatten(
                _.map(this.federations, function(federation) {
                    return federation.federates;
                })));
    }
