...
define(function(require) {
    ...
    function Game() {
		...
		this.eventTypes = [
			...
			{number: 5, type: 'disturb', spec: {level: "minor", type: "Minor"}},
			{number: 1, type: 'disturb', spec: {level: "major", type: "Major"}}
		];
		this.subsystemTypes = [
			{type: "SGL(p)", protocol: "p", cost: 50, size: 1, capacity: 0, maxTransmitted: 1, maxReceived: 1},
			{type: "SGL(o)", protocol: "o", cost: 100, size: 1, capacity: 0, maxTransmitted: 1, maxReceived: 1},
