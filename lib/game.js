...
define('game',function(require) {
     ...
     * @param {String} ops - The operations model.
     * @returns {object} The context.
     */
    Game.prototype.buildContext = function(seed, ops) {
        ...
        for(var i = 0; i < this.numPlayers; i++) {
            var operations;
            if(ops==="simple") {
                operations = new fss.SimpleOperations();
            } else if(ops==="dynamic") {
                operations = new fss.DynamicOperations();
            } else {
