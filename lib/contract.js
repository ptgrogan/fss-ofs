...
define('contract', function(require) {
    ...
    /**
     * Gets time until this contract is defaulted.
     * @returns {Number} The time to default.
     */
    Contract.prototype.getTimeToDefault = function() {
        return this.demand.getDefaultTime() - this.elapsedTime;
    };
