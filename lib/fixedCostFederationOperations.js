                    ...
                    _.each(SGLprotocols, function(protocol, k) {
                        ...
                        C.push({
                            ...
                            constant: (spacecraft.couldTransmit(protocol, 
                                    origLoc, destLoc, 1, station, context) 
                                && station.couldReceive(protocol, origLoc, 
                                    destLoc, spacecraft, 1, context))?maxSize:0,
                ...
                _.each(allSpacecraftsISL, function(spacecraft2, j) {
                    ...
                    _.each(ISLprotocols, function(protocol, k) {
                        ...
                        C.push({
                            ...
                            constraint: 'LE', 
                            constant: (spacecraft.couldTransmit(protocol, 
                                    origLoc, destLoc, 1, spacecraft2, context) 
                                && spacecraft2.couldReceive(protocol, 
                                    origLoc, destLoc, spacecraft, 1, context)
                                && spacecraft !== spacecraft2)?maxSize:0,
