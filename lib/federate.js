...
define('federate', function(require) {
    ...
    Federate.prototype.canSense = function(demand, system, context) {
        if(this.systems.indexOf(system) < 0) {
            ...
            logger.error("Demand does not exist in context.");
        } else {
    ...
    /**
     * Automatically decommissions any non-operational spacecraft.
     * @param {object} context - The context.
     */
    ...
    /**
     * Automatically defaults on any expired or non-completable contracts.
     * @param {object} context - The context.
     */
    ...
    /**
     * Automatically contracts and senses any available demands.
     * @param {object} context - The context.
     */
    ...
    /**
     * Automatically downlinks any available data.
     * @param {object} context - The context.
     */
